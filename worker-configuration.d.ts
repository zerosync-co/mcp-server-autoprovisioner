/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3e576862bb78aad1da55393c69113ecc)
// Runtime types generated with workerd@1.20250508.0 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		OAUTH_KV: KVNamespace;
		CLERK_REDIRECT_URL: "https://accounts.zerosync.co" | "https://vital-oyster-7.accounts.dev";
		MCP_SERVER_AUTOPROVISIONER_BASE_URL: "https://autoprovisioner-remote.zerosync.co" | "http://localhost:8787";
		TF_SERVICE_BASE_URL: "https://tf-service.zerosync.co" | "http://localhost:8000";
		CLERK_PUBLISHABLE_KEY: string;
		CLERK_SECRET_KEY: string;
		CLERK_JWK: string;
		MCP_OBJECT: DurableObjectNamespace<import("./remote/index").AutoProvisioner>;
	}
}
