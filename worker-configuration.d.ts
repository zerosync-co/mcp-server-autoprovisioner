/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f579392f83c2a045d15db32a0137abf9)
// Runtime types generated with workerd@1.20250508.0 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		OAUTH_KV: KVNamespace;
		CLERK_REDIRECT_URL: "https://vital-oyster-7.accounts.dev/sign-in";
		MCP_SERVER_AUTOPROVISIONER_BASE_URL: "http://localhost:8787";
		TF_SERVICE_BASE_URL: "http://localhost:8000";
		CLERK_PUBLISHABLE_KEY: string;
		CLERK_SECRET_KEY: string;
		CLERK_JWK: string;
		MCP_OBJECT: DurableObjectNamespace<import("./sse/main").AutoProvisioner>;
	}
}
